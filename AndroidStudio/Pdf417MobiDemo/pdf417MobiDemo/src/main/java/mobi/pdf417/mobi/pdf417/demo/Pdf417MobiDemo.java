package mobi.pdf417.mobi.pdf417.demo;
...
public class Pdf417MobiDemo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(mobi.pdf417.demo.R.layout.activity_main);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater menuInflater = getMenuInflater();
        menuInflater.inflate(mobi.pdf417.demo.R.menu.menu, menu);
        return true;
    }
    ...
    private void showVersionString() {
        ...
        try {
            ...
            alertDialog.setButton(this.getString(mobi.pdf417.demo.R.string.photopayOK), new DialogInterface.OnClickListener() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case mobi.pdf417.demo.R.id.menu_version:
            showVersionString();
            return true;
        }
        return false;
    ...
    public void btnScan_click(View v) {
        ...
        intent.putExtra(Pdf417ScanActivity.EXTRAS_BEEP_RESOURCE, mobi.pdf417.demo.R.raw.beep);
...
//            Pdf417MobiScanData scanData = data.getParcelableExtra(BaseBarcodeActivity.EXTRAS_RESULT);
            ...
            startActivity(Intent.createChooser(intent, getString(mobi.pdf417.demo.R.string.UseWith)));
        }
    }
}
